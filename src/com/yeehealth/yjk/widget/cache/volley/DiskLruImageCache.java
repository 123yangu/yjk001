...
public class DiskLruImageCache implements ImageCache  {
	...
	public void putBitmap( String key, Bitmap data ) {
		...
		try {
			...
			if( writeBitmapToFile( data, editor ) ) {               
				mDiskCache.flush();
				editor.commit();
				LogUtil.e( "cache_test_DISK_", "image put on disk cache " + key );
			} else {
				editor.abort();
				LogUtil.e( "cache_test_DISK_", "ERROR on: image put on disk cache " + key );
			}   
		} catch (IOException e) {
			LogUtil.e( "cache_test_DISK_", "ERROR on: image put on disk cache " + key );
			try {
	...
	public Bitmap getBitmap( String key ) {
		...
		LogUtil.e( "cache_test_DISK_", bitmap == null ? "" : "image read from disk " + key);
	...
	public void clearCache() {
		LogUtil.e( "cache_test_DISK_", "disk cache CLEARED");
		try {
			mDiskCache.delete();
		} catch ( IOException e ) {
			e.printStackTrace();
